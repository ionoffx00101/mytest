...
<!-- for Bootstrap -->
	<!-- Bootstrap Core CSS -->
	<link href="<%=cp%>/resources/bootstrapCustom/css/bootstrap.css" rel="stylesheet">
	
	<!-- Custom CSS -->
	<link href="<%=cp%>/resources/bootstrapCustom/css/stylish-portfolio.css" rel="stylesheet">
	<!-- Custom CSS2 -->
	<link href="<%=cp%>/resources/css/custom.css" rel="stylesheet">
	
	<!-- Custom Fonts -->
	<link href="<%=cp%>/resources/bootstrapCustom/font-awesome/css/font-awesome.min.css" rel="stylesheet">
	...
	<!-- jQuery -->
	<script type="text/javascript" src="<%=cp%>/resources/bootstrapCustom/js/jquery.js"></script>
	
	<!-- Bootstrap Core JavaScript -->
	<script type="text/javascript" src="<%=cp%>/resources/bootstrapCustom/js/bootstrap.js"></script>
